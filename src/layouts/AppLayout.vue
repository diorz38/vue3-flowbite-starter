        ...
        <div class="flex justify-between items-center max-w-screen-2xl mx-auto">
          <div class="flex justify-start items-center">
            ...
            >
              ...
              />
              <span
                class="self-center hidden sm:flex text-2xl font-semibold whitespace-nowrap dark:text-white"
                >Flowbite</span
              >
            </router-link>
            ...
            >
              <ul
                class="flex flex-col mt-4 space-x-6 text-sm font-medium lg:flex-row xl:space-x-8 lg:mt-0"
              >
                <li>
                  <router-link to="/"
                    class="block rounded text-primary-700 dark:text-primary-500 hover:text-blue-500 active:text-blue-500 dark:text-gray-400 dark:hover:text-white"
                    aria-current="page"
                    >Home</router-link
                  >
                </li>
                <li>
                  <a
                    href="#"
                    class="block text-gray-700 hover:text-primary-700 dark:text-gray-400 dark:hover:text-white hover:text-blue-500 active:text-blue-500"
                    >Messages</a
                  >
                </li>
                <li>
